...
6. **Jenkinsfile**: `buildPlugin(useContainerAgent: true, configurations: [[platform: 'linux', jdk: 21], [platform: 'windows', jdk: 21]])`. The hosting checker accepts only JDK 21 and 25; check the currently recommended form in the jenkins.io documentation.
