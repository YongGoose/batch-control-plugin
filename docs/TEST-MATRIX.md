...
- **총 행 수: 138** (SPEC 도출 111 + T-RT 16 + Phase 4 security regressions T-SEC-08..14 + coverage-gap row T-SEC-15 + security-02 regressions T-SEC-16..18)
- **우선순위**: P0 87 / P1 43 / P2 8 (T-SEC-16/17/18 are P0 — they pin whether a permission can be conferred; T-SEC-14 moved P2→P1, see note 29)
- **계층**: unit 3 / integration 126 / e2e 9
- **ID 그룹별 분포**: T-01 6, T-02 5, T-03 6, T-04 4, T-05 6, T-06 16, T-07 7, T-08 13, T-09 11, T-10 7, T-11 7, T-12 5, T-CFG 3, T-SEC 18, T-E2E 8, T-RT 16
